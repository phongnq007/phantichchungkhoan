...
{
    public class HosePriceBoardTempConfiguration : IEntityTypeConfiguration<HosePriceBoardTemp>
    {
        public void Configure(EntityTypeBuilder<HosePriceBoardTemp> builder)
        {
