...
{
    public class UpcomPriceBoardTempConfiguration : IEntityTypeConfiguration<UpcomPriceBoardTemp>
    {
        public void Configure(EntityTypeBuilder<UpcomPriceBoardTemp> builder)
        {
