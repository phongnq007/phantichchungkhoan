...
{
    public class HnxInsert2Db : IDisposable
    {
        ...
        public HnxInsert2Db(IPriceBoardEfRepository priceBoardEfRepository, ILogger<VnDirectCrawler> logger, string endpoint)
        {
        ...
        public async Task ExecuteAsync()
        {
            ...
            await _seleniumWebDriver.GetListPriceBoard(_endpoint, ExchangeSymbol.HNX);
